...
const ProfileScreen = ({ navigation }) => {
  ...
  // Duba ko mai amfani yana da PIN ko babu
  ...
  const fullName = `${userData?.firstName || ""} ${userData?.surname || userData?.lastName || ""}`.trim() || userData?.name || "Enterprise Member";
  ...
  return (
    ...
    >
      ...
      >
        {/* Tier-1 Executive Profile Hero Header */}
        <LinearGradient
          colors={
            isDarkMode
              ? ["#0c1322", "#080c14"]
        ...
        >
          ...
          <View style={styles.identityContainer}>
            ...
            <View style={styles.roleChip}>
              <Ionicons name="shield-checkmark" size={13} color="#38bdf8" style={{ marginRight: 4 }} />
              <Text style={styles.roleChipText}>
                {(userData?.role || userData?.accountType || "Verified Member").toUpperCase()}
              </Text>
            </View>
          </View>
        </LinearGradient>
        ...
        <View style={styles.bodyWrapper}>
          ...
          >
            {/* Setup or Change Transaction PIN */}
            <TouchableOpacity
            ...
            >
              <View style={[styles.rowIconContainer, { backgroundColor: "rgba(16,185,129,0.1)" }]}>
                <MaterialCommunityIcons name="lock-reset" size={18} color="#10b981" />
              </View>
            ...
            {/* Logout Session */}
            <TouchableOpacity
              style={[styles.clickableRowItem, { borderBottomWidth: 0 }]}
              onPress={handleLogout}
              activeOpacity={0.7}
            >
              <View style={[styles.rowIconContainer, { backgroundColor: "rgba(239,68,68,0.1)" }]}>
                <Ionicons name="log-out-outline" size={18} color="#ef4444" />
              </View>
              <View style={styles.rowTextContainer}>
                <Text style={[styles.rowTitleText, { color: "#ef4444" }]}>Session Termination</Text>
                <Text
                  style={[
                    styles.rowSubText,
          ...
          <View style={styles.appVersionFooter}>
            <Text style={styles.versionFooterText}>Ayax Xpress Terminal • Enterprise v2.0</Text>
            <Text style={styles.encryptionNotice}>Powered by Ayax Digital Solutions</Text>
          </View>
        </View>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  appVersionFooter: { alignItems: "center", marginTop: 24, marginBottom: 10 },
